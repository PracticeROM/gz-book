...
combination can be changed (see [Settings](./menus/settings.html)). Use the D-Pad
...
These features can be configured from the settings menu (see [Settings](./menus/settings.html)).
